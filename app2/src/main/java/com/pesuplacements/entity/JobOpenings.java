...
public class JobOpenings {
    ...
    @NotBlank(message = "Job title cannot be empty")  // Replace @NotEmpty with @NotBlank
    private String jobTitle;

    @Column(name = "company_name", length = 100, nullable = false)
    @NotBlank(message = "Company name cannot be empty")  // Replace @NotEmpty with @NotBlank
    private String companyName;

    @Column(name = "job_description", nullable = false)
    @NotBlank(message = "Job description cannot be empty")  // Replace @NotEmpty with @NotBlank
